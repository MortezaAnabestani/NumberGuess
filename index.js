...
function startGame(){
    maximumNumber = Number(maximumInput.value); //از آنجایی که هر نوع محتوا در سند اچ تی ام ال به صورت رشته خوانده می شود، بهتر است در چنین مواردی آن ها را تبدیل به عدد کنیم
    if (maximumNumber > 10){
        ...
        p.outerHTML = '<p class="red">عدد واردشده باید بزرگ‌تر از 10 باشد</p>'        
    }
}
